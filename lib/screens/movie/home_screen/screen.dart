    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          // GestureDetector(
          //   onTap: (){
          //     Navigator.of(context).push(MaterialPageRoute(builder:(context)=>movieDetails(movie: movie, formkey: formkey, userindex: userindex, commentController: commentController) ));
          //   },
          //   child: Column(
          //     children: [
          //       Text('data')
